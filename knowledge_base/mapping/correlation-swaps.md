# FpML → CDM mapping — Correlation swaps — STUB

> Status: scaffold. Source side: [../fpml/correlation-swaps.md](../fpml/correlation-swaps.md). Read
...
## CDM target
A `PerformancePayout` (correlation return) with a basket observable.

## How to fill this in
Work a train pair in `data/train/correlation-swaps-*/` (FpML + expected CDM JSON): for each populated CDM
