# FpML → CDM mapping — Credit derivatives — STUB

> Status: scaffold. Source side: [../fpml/credit.md](../fpml/credit.md). Read
...
## CDM target
A `CreditDefaultPayout` (protection/general terms) plus an `InterestRatePayout`/fee for the premium leg.

## How to fill this in
Work a train pair in `data/train/credit-*/` (FpML + expected CDM JSON): for each populated CDM
