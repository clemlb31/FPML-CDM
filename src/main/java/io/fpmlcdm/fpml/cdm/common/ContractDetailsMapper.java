...
public final class ContractDetailsMapper {
    ...
    private static ContractualMatrix buildContractualMatrix(Element cm) {
        Element matrixTypeEl = io.fpmlcdm.fpml.cdm.common.XmlUtils.child(cm, "matrixType");
        ...
        Element matrixTermEl = io.fpmlcdm.fpml.cdm.common.XmlUtils.child(cm, "matrixTerm");
