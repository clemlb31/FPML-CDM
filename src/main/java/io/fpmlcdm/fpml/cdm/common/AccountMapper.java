 ...
 *   - {@code <accountId>}                 â†’ accountNumber.value
 *   - {@code <accountName>}               â†’ accountName.value (when present)
 *   - {@code <accountBeneficiary href>}   â†’ accountBeneficiary.externalReference
 *   - {@code <servicingParty href>}       â†’ servicingParty.externalReference
