 ...
 * {@link io.fpmlcdm.fpml.cdm.detect.ProductDetector#dispatch(Element)} for every trade.
 * Build a fresh {@link io.fpmlcdm.fpml.cdm.common.MappingContext} in {@code map()},
 * never share state across invocations.
 *
 * <p>{@code map()} may return {@code null} to signal "no salvageable output"
 * for this trade; the caller ({@link io.fpmlcdm.fpml.cdm.FpmlToCdmConverter}) currently
 ...
 *       {@link io.fpmlcdm.fpml.cdm.payouts.InterestRatePayoutMapper} sees the right mapping.</li>
 *
 ...
 *
 * <h2>Counterparty list: reuse {@link SwapMapper#buildCounterparties(io.fpmlcdm.fpml.cdm.common.MappingContext)}</h2>
 *
 ...
 *   <li>Register the FpML element in {@link io.fpmlcdm.fpml.cdm.detect.ProductDetector#dispatch(Element)}
 ...
 *   <li>Add a pair to {@code data/ground_truth/fpml-cdm/<category>/{fpml,cdm}/} or rely on existing categories
